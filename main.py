...
def main():
    ...
    show_img("overlayed_img",overlay_img)
...
def combine_vertically(img1, img2):
    if img1 is None or img2 is None:
        ...
        # img1 , img2 = crop_img(img1 , img2 , False)

        # img1 = cv2.resize(img1 , (img1.shape[0]//4,img2.shape[0]//2))
        # img2 = cv2.resize(img2 , (img2.shape[0]//2,img2.shape[0]//2))
        # h_combined = cv2.hconcat([img1,img2])
        # return h_combined

        img1= cv2.resize(img1, (img1.shape[1] // 2, img1.shape[0] // 2)).copy()
        img2 = cv2.resize(img2, (img1.shape[1] // 2, img2.shape[0] // 2)).copy()
